...
# Load local .env first, then fall back to the repo-root .env used by earlier labs.
...
def run():
    ...
    Run the crew.
    """
    topic = sys.argv[1] if len(sys.argv) > 1 else "Find the best places to live in the USA"
    inputs = {
        'topic': topic,
